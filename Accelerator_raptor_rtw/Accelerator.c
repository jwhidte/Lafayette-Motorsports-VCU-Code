 ...
 * C/C++ source code generated on : Wed Nov 13 18:05:13 2024
 *
...
{
  /* Start for S-Function (raptor_sfun_digital_in): '<S30>/raptor_digital_in' */

  /* S-Function Block: WAKE_INPUT1 */
  {
  }

  /* Start for S-Function (raptor_sfun_digital_out): '<S30>/raptor_digital_out' */

  /* S-Function Block: POWER_HOLD */
  {
  }

  /* InitializeConditions for S-Function (raptor_sfun_delta_time): '<S31>/raptor_delta_time' */
...
void Accelerator_Background(void)
{
  ...
  /* S-Function (raptor_sfun_digital_in): '<S30>/raptor_digital_in' */
  /* S-Function Block: WAKE_INPUT1 */
  {
    rtb_raptor_digital_in = swsh_ignswSt();
  }

  /* S-Function (raptor_sfun_delta_time): '<S31>/raptor_delta_time' */
  {
   ...
   *  S-Function (raptor_sfun_adjustment): '<S31>/raptor_adjustment3'
   *  S-Function (raptor_sfun_adjustment): '<S31>/raptor_adjustment4'
   */
   ...
   *  S-Function (raptor_sfun_data_read): '<S30>/raptor_data_read1'
   */
  rtb_LogicalOperator1_h = (rtb_Logic || KeepModuleOn_Data());

  /* Outputs for Triggered SubSystem: '<S30>/Raise Shutdown Event' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S30>/Raise Shutdown Event' */
  /* Outputs for Enabled and Triggered SubSystem: '<S30>/Raise Startup Event' incorporates:
  ...
  if (FgndTasksStopped_Data() && (rtb_LogicalOperator1_h &&
    ...
    /* S-Function (raptor_sfun_data_write): '<S33>/raptor_data_write' incorporates:
     *  S-Function (raptor_sfun_data_read): '<S33>/raptor_data_read'
     */
    Startup_Charge_Data() = GLV_Battery_Charge_Data();
  }

  /* End of S-Function (raptor_sfun_data_read): '<S30>/raptor_data_read' */
  ...
  /* End of Outputs for SubSystem: '<S30>/Raise Shutdown Event' */
  /* End of Outputs for SubSystem: '<S30>/Raise Startup Event' */

  /* UnitDelay: '<S30>/Unit Delay' */
  rtb_LogicalOperator2_c = Accelerator_DWork.UnitDelay_DSTATE_e;

  /* Outputs for Triggered SubSystem: '<S30>/Store EEPROM' incorporates:
  ...
  if ((!Accelerator_DWork.UnitDelay_DSTATE_e) &&
     ...
     *  S-Function (raptor_sfun_data_read): '<S34>/raptor_data_read'
     *  S-Function (raptor_sfun_data_read): '<S34>/raptor_data_read1'
     */
    rtb_Add = GLV_Battery_Charge_Data() - Used_Ah_Data();

    /* S-Function (raptor_sfun_data_write): '<S34>/raptor_data_write' */
    GLV_Battery_Charge_Data() = rtb_Add;
  ...
  /* End of UnitDelay: '<S30>/Unit Delay' */
  Accelerator_PrevZCSigState.StoreEEPROM_Trig_ZCE = rtb_LogicalOperator2_c;

  /* End of Outputs for SubSystem: '<S30>/Store EEPROM' */

  /* S-Function (raptor_sfun_data_write): '<S30>/raptor_data_write' */
  KeySw_Bgnd_Data() = rtb_Logic;

  /* S-Function (raptor_sfun_nv_status): '<S30>/raptor_sfun_nv_status' */
  /* S-Function Block */
  {
  ...
  /* S-Function (raptor_sfun_digital_out): '<S30>/raptor_digital_out' */
  /* S-Function Block: POWER_HOLD */
  {
    {
...
void Accelerator_FunctionCallSubsystem_Disable(void)
{
  ...
  if (Accelerator_DWork.If_ActiveSubsystem == 0) {
    /* Disable for S-Function (raptor_sfun_can_txmsg): '<S29>/raptor_can_txmsg' incorporates:
     *  Constant: '<S29>/Constant'
     */
    /* Level2 S-Function Block: '<S29>/raptor_can_txmsg' (raptor_sfun_can_txmsg) */
    can_set_period_793__0001(0);
  }
...
void Accelerator_FunctionCallSubsystem(void)
{
  ...
  if (rtAction == 0) {
    if (rtPrevAction != 0) {
       ...
       *  Constant: '<S29>/Constant'
       *  S-Function (raptor_sfun_can_txmsg): '<S29>/raptor_can_txmsg'
       */
      /* Level2 S-Function Block: '<S29>/raptor_can_txmsg' (raptor_sfun_can_txmsg) */
      can_set_period_793__0001(0U);
     ...
     *  ActionPort: '<S29>/Action Port'
     */
    /* S-Function (raptor_sfun_can_txmsg): '<S29>/raptor_can_txmsg' incorporates:
     *  Constant: '<S29>/Constant'
     */

    /* S-Function Block:<S29>/raptor_can_txmsg */
    {
      ...
      data[5U] |= temp_shift;
      can_set_period_793__0001(0U);
      can_send_793__0001(192U & 0x7FF, 0, 8U, &data[0]);
    }
  ...
  /* S-Function Block:<S2>/raptor_can_txmsg */
  {
    ...
    data[5U] |= temp_shift;
    can_set_period_796__0001(0U);
    can_send_796__0001(193U & 0x7FF, 0, 8U, &data[0]);
  }
...
{
  /* MATLAB Function 'Subsystem/MATLAB Function': '<S23>:1' */
  /* '<S23>:1:2' */
...
void Accelerator_Foreground_Init(void)
{
  ...
  /* SystemInitialize for Logic: '<S22>/Logic' incorporates:
   *  Outport: '<S22>/!Q'
   */
...
void Accelerator_Foreground(void)
{
  ...
  /* S-Function (raptor_sfun_override): '<S19>/raptor_override2' incorporates:
   *  S-Function (raptor_sfun_fault_status): '<S19>/raptor_fault_status'
   */
  ...
  /* S-Function (raptor_sfun_override): '<S19>/raptor_override3' incorporates:
   *  S-Function (raptor_sfun_fault_status): '<S19>/raptor_fault_status1'
   */
  ...
  /* S-Function (raptor_sfun_override): '<S19>/raptor_override' */
  ...
  /* S-Function (raptor_sfun_override): '<S19>/raptor_override1' */
  if (POT2_OvrSts_Data()) {
   ...
   */
  /* MATLAB Function 'Foreground/MATLAB Function': '<S15>:1' */
  /* '<S15>:1:2' */
  ...
  if (Accelerator_B.raptor_override_b == rtb_Compare_c) {
    /* SignalConversion generated from: '<S22>/D' */
   ...
   *  SignalConversion generated from: '<S15>/ SFunction '
   */
  /* MATLAB Function 'Foreground/MATLAB Function1': '<S16>:1' */
  /* '<S16>:1:2' */
  ...
  /* S-Function Block:<S1>/raptor_can_rxmsg */
  {
    ...
    can_get_325__0002(NULL, NULL, NULL, &data[0], 8);

    /* Signal: D1_Motor_Angle_Electrical      */
    {
      uint32_T tD1_Motor_Angle_Electrical ;
      tD1_Motor_Angle_Electrical = 0;
      tD1_Motor_Angle_Electrical |= ((uint32_T)data[0U]) ;
      tD1_Motor_Angle_Electrical |= ((uint32_T)data[1U]) << 8;
      rtb_Divide_i = (((real_T) tD1_Motor_Angle_Electrical / (real_T) 10.0) );
    }

    /* Signal: D2_Motor_Speed                 not connected */

    /* Signal: D3_Electrical_Output_Frequency not connected */

    /* Signal: D4_Delta_Resolver_Filtered     not connected */
  }

  /* Abs: '<S1>/Abs' */
  rtb_Divide_i = fabsf((real32_T)rtb_Divide_i);
  ...
  if (RPM_override_OvrSts_Data()) {
    ...
    Accelerator_B.raptor_override3 = rtb_Divide_i;
  }

  /* S-Function (raptor_sfun_table_axis): '<S21>/raptor_table_axis' */
  {
    int idx;
    for (idx=0;idx<1;idx++) {
  ...
  /* S-Function (raptor_sfun_table_interpolate_1d): '<S21>/raptor_table_interpolate_1d' */
  {
    rtb_Divide_i = TableInterpolate1D_real32_T( Accelerator_B.raptor_table_axis,
   ...
   *  Product: '<S5>/Product'
   */
  rtb_Divide_i = rtb_Switch * rtb_Divide_i * 0.9;
  ...
  if (Torque_map_val_override_OvrSts_Data()) {
    ...
    Accelerator_B.raptor_override16 = rtb_Divide_i;
  }
  ...
  if (Accelerator_B.raptor_override16 > 3276.0) {
    ...
    rtb_Divide_i = Accelerator_B.raptor_override16;
  }
  ...
  if (Torque_cmd_override_OvrSts_Data()) {
    ...
    Accelerator_B.raptor_override = rtb_Divide_i;
  }
  ...
  rtb_Divide_i = Accelerator_DWork.UnitDelay_DSTATE_l;

  /* Logic: '<S20>/Logical Operator' incorporates:
   *  Constant: '<S26>/Constant'
   *  RelationalOperator: '<S26>/Compare'
   */
  rtb_LogicalOperator3_g = !(rtb_Divide_i > 4.0);
   ...
   *  Sum: '<S20>/Add'
   */
  Accelerator_DWork.UnitDelay_DSTATE_l = (rtb_DataTypeConversion4 + rtb_Divide_i)
   ...
   */
  rtb_Divide_i = (real_T)Accelerator_B.raptor_override12 * 0.00122100122;
   ...
   *  Sum: '<S1>/Add2'
   */
  rtb_Divide_i = rtb_Divide_i * 2.145 / (5.0 - rtb_Divide_i);
  ...
  if (Temp_resistance_override_OvrSts_Data()) {
    ...
    Accelerator_B.raptor_override13 = rtb_Divide_i;
  }
   ...
   */
  rtb_GreaterThan1 = (rtb_Divide_i > 100.0);
   ...
   *  Constant: '<S1>/100 Ohm'
   */
  rtb_GreaterThan1 = (rtb_Divide_i < 0.1);
   ...
   *  S-Function (raptor_sfun_adjustment): '<S1>/raptor_adjustment8'
   */
  if (Accelerator_B.raptor_override10) {
    rtb_DataTypeConversion4 = (Cooling_pump_PWM_D_Data());
  } else {
    rtb_DataTypeConversion4 = 0.0;
  }
  ...
  /* S-Function (raptor_sfun_adjustment): '<S19>/raptor_adjustment2' */
  ...
  /* S-Function (raptor_sfun_fault_def): '<S19>/raptor_fault_def' */
  ...
  /* S-Function (raptor_sfun_adjustment): '<S19>/raptor_adjustment3' */
  rtb_DataTypeConversion4 = (POT2_InputLowThresh_Data());

  /* RelationalOperator: '<S19>/Relational Operator' */
  rtb_LogicalOperator3_g = (Accelerator_B.u1_l < rtb_DataTypeConversion4);

  /* S-Function (raptor_sfun_fault_def): '<S19>/raptor_fault_def1' */
  ...
  /* S-Function (raptor_sfun_measurement): '<S19>/raptor_measurement1' */
  POT2LowProbe_Data() = Accelerator_B.u1_p;

  /* S-Function (raptor_sfun_measurement): '<S19>/raptor_measurement2' */
  ...
  /* MATLAB Function 'Foreground/MATLAB Function2': '<S17>:1' */
  /* '<S17>:1:2' */
...
void Accelerator_initialize(void)
{
  ...
  Accelerator_PrevZCSigState.RaiseStartupEvent_Trig_ZCE = POS_ZCSIG;
  Accelerator_PrevZCSigState.StoreEEPROM_Trig_ZCE = ZERO_ZCSIG;
  Accelerator_PrevZCSigState.GLVUsedAh_Trig_ZCE = UNINITIALIZED_ZCSIG;
