...
echo ### Beginning Build for Accelerator_021 ...
SET BUILD_SCRIPTS_DIR=.\Build_Scripts
SET MAKE="C:\Program Files (x86)\NewEagle\Raptor\2022b_3.0.14889\GCM-1793-196-1503\tools\make\bin\make.exe"
SET PERL="C:\Program Files (x86)\NewEagle\Raptor\2022b_3.0.14889\GCM-1793-196-1503\tools\perl\perl\bin\perl.exe"
SET HEXMOD="C:\Program Files (x86)\NewEagle\Raptor\2022b_3.0.14889\GCM-1793-196-1503\tools\hexmod17\3.9.6.3\bin\hexmod.exe"
...
copy .\_buildgen\Output\NewEagle_ME1735_810D0_8A13.hex "C:\Developement\Motorsports\VCU\Accelerator_raptor_rtw\Accelerator_021.hex" /Y
