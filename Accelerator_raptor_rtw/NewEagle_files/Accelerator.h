...
typedef struct {
  ...
  real_T u1;                           /* '<S18>/raptor_override1' */
  real_T u1_c;                         /* '<S19>/raptor_override1' */
  ...
  uint16_T raptor_table_axis;          /* '<S21>/raptor_table_axis' */
  uint16_T raptor_override4;           /* '<S1>/raptor_override4' */
  uint16_T u1_n;                       /* '<S18>/raptor_override' */
  uint16_T u1_l;                       /* '<S19>/raptor_override' */
  ...
  boolean_T D;                         /* '<S22>/D' */
  boolean_T Logic;                     /* '<S22>/Logic' */
  boolean_T u1_d;                      /* '<S18>/raptor_override2' */
  boolean_T u1_g;                      /* '<S18>/raptor_override3' */
  boolean_T u1_a;                      /* '<S19>/raptor_override2' */
  boolean_T u1_p;                      /* '<S19>/raptor_override3' */
  ...
  rtB_MATLABFunction_Accelerator sf_MATLABFunction_i;/* '<S19>/MATLAB Function' */
  rtB_MATLABFunction_Accelerator sf_MATLABFunction_m;/* '<S18>/MATLAB Function' */
} BlockIO_Accelerator;
...
typedef struct {
  ...
  real_T UnitDelay_DSTATE_l;           /* '<S20>/Unit Delay' */
  real_T UnitDelay_DSTATE_b;           /* '<S31>/Unit Delay' */
  uint32_T UD_DSTATE_p;                /* '<S13>/UD' */
  uint32_T raptor_delta_time_DWORK1;   /* '<S31>/raptor_delta_time' */
  uint8_T DelayInput1_DSTATE;          /* '<S25>/Delay Input1' */
  boolean_T DelayInput1_DSTATE_c;      /* '<S35>/Delay Input1' */
  boolean_T UnitDelay2_DSTATE;         /* '<S31>/Unit Delay2' */
  boolean_T UnitDelay_DSTATE_e;        /* '<S30>/Unit Delay' */
  boolean_T UnitDelay1_DSTATE_f;       /* '<S30>/Unit Delay1' */
  int8_T If_ActiveSubsystem;           /* '<S2>/If' */
} D_Work_Accelerator;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState GLVUsedAh_Trig_ZCE;       /* '<S1>/GLV Used Ah' */
  ZCSigState StoreEEPROM_Trig_ZCE;     /* '<S30>/Store EEPROM' */
  ZCSigState RaiseStartupEvent_Trig_ZCE;/* '<S30>/Raise Startup Event' */
  ZCSigState RaiseShutdownEvent_Trig_ZCE;/* '<S30>/Raise Shutdown Event' */
 ...
 * '<S14>'  : 'Accelerator/Foreground/GLV Used Ah'
 * '<S15>'  : 'Accelerator/Foreground/MATLAB Function'
 * '<S16>'  : 'Accelerator/Foreground/MATLAB Function1'
 * '<S17>'  : 'Accelerator/Foreground/MATLAB Function2'
 * '<S18>'  : 'Accelerator/Foreground/POT1'
 * '<S19>'  : 'Accelerator/Foreground/POT2'
 * '<S20>'  : 'Accelerator/Foreground/Triggered Single Pulse'
 * '<S21>'  : 'Accelerator/Foreground/Calculate Torque/raptor_table_1d'
 * '<S22>'  : 'Accelerator/Foreground/D Latch/D Latch'
 * '<S23>'  : 'Accelerator/Foreground/POT1/MATLAB Function'
 * '<S24>'  : 'Accelerator/Foreground/POT2/MATLAB Function'
 * '<S25>'  : 'Accelerator/Foreground/Triggered Single Pulse/+ve edge detect'
 * '<S26>'  : 'Accelerator/Foreground/Triggered Single Pulse/Compare To Constant'
 * '<S27>'  : 'Accelerator/Foreground/Triggered Single Pulse/+ve edge detect/Positive'
 * '<S28>'  : 'Accelerator/Function-Call Subsystem/Compare To Constant'
 * '<S29>'  : 'Accelerator/Function-Call Subsystem/If Action Subsystem'
 * '<S30>'  : 'Accelerator/Power Up_Down/Background'
 * '<S31>'  : 'Accelerator/Power Up_Down/Background/Debounce'
 * '<S32>'  : 'Accelerator/Power Up_Down/Background/Raise Shutdown Event'
 * '<S33>'  : 'Accelerator/Power Up_Down/Background/Raise Startup Event'
 * '<S34>'  : 'Accelerator/Power Up_Down/Background/Store EEPROM'
 * '<S35>'  : 'Accelerator/Power Up_Down/Background/Debounce/Detect Change'
 * '<S36>'  : 'Accelerator/Power Up_Down/Background/Raise Shutdown Event/raptor_shutdown'
 * '<S37>'  : 'Accelerator/Power Up_Down/Background/Raise Startup Event/raptor_startup'
 * '<S38>'  : 'Accelerator/Power Up_Down/Background/Store EEPROM/raptor_store_nv'
 */
