...
void rxFn_325__0002(void * data);

#define START_SECTION_volatile_SlowRam_oem_32bit
#include "swsh_rb2oem.h"

uint8_T rxBuf_325__0002[1U][8];
uint8_T rxLen_325__0002[1U];
uint16_T rxAge_325__0002;
uint32_T rxID_325__0002[1U];

#define STOP_SECTION_volatile_SlowRam_oem_32bit
#include "swsh_rb2oem.h"

uint8_T rxQHead_325__0002 = 0;
uint8_T rxQTail_325__0002 = 0;
...
/* <S29>/raptor_can_txmsg */
uint32_T can_set_period_793__0001(uint32_T);

/* <S2>/raptor_can_txmsg */
uint32_T can_set_period_796__0001(uint32_T);
...
uint32_T can_set_period_Tx_XCP_XCP1(uint32_T);
...
void pre_start_CAN_CAN1(void)
{
  if (RxTrig_XCP_BC_XCP1_msgID != 0x7e0 && RxTrig_XCP_BC_XCP1_msgID != 0x7e8) {
    canMsgInfo[RX_MSG_ENTRY_START + 1].MessageId = RxTrig_XCP_BC_XCP1_msgID;
  }

  if (RxTrig_XCP_CMD_XCP1_msgID != 0x7e0 && RxTrig_XCP_CMD_XCP1_msgID != 0x7e8)
  {
    canMsgInfo[RX_MSG_ENTRY_START + 2].MessageId = RxTrig_XCP_CMD_XCP1_msgID;
  }

  {
    memset((void *)&rxBuf_325__0002[0][0], 0, sizeof(rxBuf_325__0002));
    memset((void *)&rxLen_325__0002[0], 0, sizeof(rxLen_325__0002));
    rxAge_325__0002 = MAX_AGE;
  }
...
void rxFn_325__0002(void * data)
{
  ...
  if ((msg->parameter1 == 8U) ) {
    for (i = 0; i < 8; i++) {
      if (i < msg->parameter1)
        rxBuf_325__0002[rxQHead_325__0002][i] = b[i];
      else
        rxBuf_325__0002[rxQHead_325__0002][i] = 0;
    }

    rxLen_325__0002[rxQHead_325__0002] = msg->parameter1;
    rxID_325__0002[rxQHead_325__0002] = msg->message_id;
    if ((rxQHead_325__0002 == rxQTail_325__0002) && (rxAge_325__0002 == 0))
      rxQTail_325__0002 = (rxQTail_325__0002 + 1) % 1U;
    if ((rxQHead_325__0002 == (rxQTail_325__0002 + 1)% 1U) && (rxAge_325__0002
         != 0))
      rxQTail_325__0002 = (rxQTail_325__0002 + 1) % 1U;
    rxQHead_325__0002 = (rxQHead_325__0002 + 1 ) % 1U;
    rxAge_325__0002 = 0;
  }
}

uint8_T can_get_325__0002(uint16_T *age, uint32_T* id, uint8_T* extended,
  uint8_T *data, uint8_T length)
{
  ...
  if (age != NULL)
    *age = rxAge_325__0002;
  if (id != NULL)
    *id = rxID_325__0002[rxQTail_325__0002];
  if (extended != NULL)
    *extended = 0U;
  if (length > 8)
    length = 8;
  if (data != NULL) {
    if (length > rxLen_325__0002[rxQTail_325__0002])
      length = rxLen_325__0002[rxQTail_325__0002];
    for (i = 0; i < 8; i++)
      data[i] = rxBuf_325__0002[rxQTail_325__0002][i];
  }

  if ((rxQHead_325__0002 != (rxQTail_325__0002 + 1)% 1U) && (rxAge_325__0002 ==
       0))
    rxQTail_325__0002 = (rxQTail_325__0002 + 1) % 1U;
  else if (rxAge_325__0002 < MAX_AGE)
    rxAge_325__0002++;
  return length;
}
...
/**** txMsgNum: 0 										 ****/
/**** i: 0 										 				 ****/
void can_send_793__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
...
uint32_T can_set_period_793__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
/**** txMsgNum: 1 										 ****/
/**** i: 1 										 				 ****/
void can_send_796__0001(uint32_T id, uint8_T extended, uint8_T length, const
  uint8_T *data)
{
  if (!can_CAN1_startupDelay) {
    can_update_CAN1(id, extended, (length > 8U) ? 8U : length, data);
...
uint32_T can_set_period_796__0001(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
...
uint32_T can_set_period_Tx_XCP_XCP1(uint32_T period)
{
  if (period > 65535)
    period = 65535;
  return period;
